            ...
            `}
                      ...
                      <li>
                        ...
                        >
                          <span className="d-flex align-items-center align-middle">
                            <i
                              className={`bx bx-credit-card flex-shrink-0 me-2  ${
                                theme == "dark" ? "text-white" : "text-black"
                              } `}
                            ></i>
                            <span
                ...
                <Col>
                  <li className="nav-item dropdown-shortcuts navbar-dropdown dropdown me-2 me-xl-0">
                    ...
                    <div
                      className={` dropdown-menu dropdown-menu-center py-0   ${
                        theme == "dark" ? "myDark" : "myLight"
                      } `}
                    >
                      ...
                      <div className="dropdown-shortcuts-list scrollable-container">
                        ...
                        >
                          ...
                          <div className="dropdown-shortcuts-item col">
                            <span className="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                              <i
                                className={` bx bx-help-circle fs-4 ${
                                  theme == "dark" ? "text-info" : "text-black"
                                } `}
                              ></i>
                            </span>
                ...
                <Col>
                  <li
                    className="nav-item" /*   style={{position:"absolute",left: "0",top: "30%"}}*/
                  >
                    <button
                    ...
                    >
                      <i
                        className={`menu-icon tf-icons fa fa-list  ${
                          theme == "dark" ? "text-white" : "text-black"
                        } `}
                      ></i>
                    </button>
